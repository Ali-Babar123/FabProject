  ...
  return (
    <div className="w-full border-r border-gray-200">
      ...
      <div className="border-b border-gray-200">
        ...
        >
          <h3 className="text-base font-medium text-gray-900">{t('filters.availability', 'Availability')}</h3>
        ...
        {sections.availability && (
          <div className="px-4 py-2 mb-2 space-y-2">
            <label className="flex items-center cursor-pointer">
              ...
              />
              <span className="ml-2 text-sm text-gray-700">{t('filters.inStockOnly', 'In stock only')}</span>
            </label>
          </div>
        )}
      </div>
      ...
      <div className="border-b border-gray-200">
        ...
        >
          <h3 className="text-base font-medium text-gray-900">{t('filters.price', 'Price')}</h3>
          {sections.price ? (
            <ChevronUp className="w-5 h-5 text-gray-500" />
          ) : (
            <ChevronDown className="w-5 h-5 text-gray-500" />
        ...
        {sections.price && (
          <div className="px-4 py-2 mb-2 space-y-3">
            <div className="flex items-center justify-between space-x-2">
              ...
              <span className="text-gray-500 text-sm">{t('filters.to', 'to')}</span>
              <div className="relative flex-1">
                <span className="absolute left-2 top-1/2 -translate-y-1/2 text-gray-500 text-sm">$</span>
                <input
                  type="text"
      ...
      {/* Product Type Filter - COMMENTED OUT */}
      {/* <div className="border-b border-gray-200">
        <button
          className="flex items-center justify-between w-full px-4 py-3 hover:bg-gray-50 transition-colors"
