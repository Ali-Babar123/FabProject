...
{t('filters.filter', 'Filter')}
          ...
          <div className="flex items-center">
            <div className="relative">
              ...
              >
                <option value="default">{t('filters.sortBy', 'Sort by')}</option>
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        >
          ...
          <div className="sm:hidden p-4 border-b border-gray-200 flex justify-between items-center">
            <h2 className="text-lg font-medium">{t('filters.filters', 'Filters')}</h2>
            <button
              onClick={toggleFilterMenu}
          ...
          <CategoryFilters filters={filters} onFilterChange={handleFilterChange} />
           ...
           <div className="sm:hidden p-4 border-t">
                ...
                >
{t('filters.viewResults', 'View Results')} ({filteredAndSortedProducts.length})
                </button>
            </div>
        </div>
...
{t('filters.noProductsMatch', 'No products match your current filters.')}
              </div>
          )}
        </div>
      </div>
